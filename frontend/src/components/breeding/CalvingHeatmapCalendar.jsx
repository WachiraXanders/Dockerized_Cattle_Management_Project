          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="flex items-center gap-2 text-base">
                <CalendarDays className="w-5 h-5 text-primary" /> Calving Map
              </CardTitle>
          ...
          <CardContent>
            {upcoming.length === 0 ? (
              ...
              <div className="space-y-2">
                {upcoming.map((e, i) => (
                  <div key={i} className="flex items-start gap-2 p-2 rounded-lg bg-primary/10">
                    <Baby className="w-4 h-4 mt-0.5 flex-shrink-0 text-primary" />
                    <div className="min-w-0">
                      <p className="text-xs font-semibold text-primary">{format(e.date, 'MMM d')}</p>
