...
const ROLES = [
  { value: 'admin', label: 'Admin', color: 'bg-destructive/10 text-destructive', icon: Crown },
  { value: 'manager', label: 'Manager', color: 'bg-accent text-accent-foreground', icon: Shield },
  { value: 'staff', label: 'Staff', color: 'bg-accent text-accent-foreground', icon: User },
                    ...
                    <TableCell>
                      {!isSelf && (
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-8 w-8 text-rose-500 hover:text-destructive hover:bg-destructive/10"
