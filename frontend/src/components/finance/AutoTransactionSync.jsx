    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          ...
          {totalPending === 0 ? (
            <span className="text-sm text-primary flex items-center gap-1"><CheckCircle2 className="w-4 h-4" /> Ledger is up to date</span>
          ) : (
            <span className="text-sm text-gold">{totalPending} cost record(s) not yet in the ledger</span>
          )}
        </div>
      </CardContent>
    </Card>
