...
const colorMap = {
  emerald: { badge: 'bg-primary/10 text-primary', btn: 'bg-emerald-600 hover:bg-emerald-700', icon: 'bg-primary/10 text-primary' },
  blue: { badge: 'bg-accent text-accent-foreground', btn: 'bg-blue-600 hover:bg-blue-700', icon: 'bg-accent text-accent-foreground' },
  rose: { badge: 'bg-destructive/10 text-destructive', btn: 'bg-rose-600 hover:bg-rose-700', icon: 'bg-destructive/10 text-destructive' },
};
