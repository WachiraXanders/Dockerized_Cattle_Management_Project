          ...
          {forecast.alerts && forecast.alerts.length > 0 && (
            <div className="space-y-2">
              {forecast.alerts.map((alert, idx) => (
                <Alert key={idx} className="bg-gold/10 border-gold/20">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center gap-2 mb-4">
                <Badge className={forecast.trend_percentage >= 0 ? 'bg-primary/10 text-primary' : 'bg-destructive/10 text-destructive'}>
            ...
            <CardContent>
              <div className="space-y-3">
                {forecast.forecast.map((month, idx) => (
                  <div key={idx} className="flex items-center justify-between p-3 bg-accent rounded-lg border border-accent">
                    <div>
                      <span className="font-semibold text-accent-foreground">{month.month}</span>
                      <p className="text-xs text-accent-foreground">Confidence: {month.confidence}</p>
                    </div>
            ...
            <CardContent>
              <div className="space-y-3">
                {forecast.recommendations.map((rec, idx) => (
                  <div key={idx} className="flex gap-3 p-3 bg-primary/10 rounded-lg border border-primary/20">
