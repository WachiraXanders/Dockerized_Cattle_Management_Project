  ...
  return (
    <div className="space-y-2">
      {activeAlerts.map((a) => {
        ...
        return (
          <div key={a.id} className="flex items-center justify-between gap-3 bg-gold/10 border border-gold/20 rounded-xl px-4 py-3">
            <div className="flex items-start gap-2">
              <TrendingDown className="w-4 h-4 text-gold mt-0.5 shrink-0" />
