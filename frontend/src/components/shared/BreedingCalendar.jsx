...
const EVENT_TYPES = {
  calving: { label: 'Calving', color: 'bg-emerald-500', textColor: 'text-primary', bg: 'bg-primary/10', icon: Baby },
  heat: { label: 'Heat Cycle', color: 'bg-rose-400', textColor: 'text-destructive', bg: 'bg-destructive/10', icon: Flame },
  dryOff: { label: 'Dry-Off', color: 'bg-amber-500', textColor: 'text-gold', bg: 'bg-gold/10', icon: MilkOff },
};
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      today ? "border-emerald-400 bg-primary/10" : "border-transparent hover:border-border hover:bg-muted/60",
                      isSelected && "border-emerald-500 bg-primary/10 ring-1 ring-emerald-400"
                    )}
                  >
                    <span className={cn(
