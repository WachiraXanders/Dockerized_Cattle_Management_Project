        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div className="bg-accent rounded-lg p-4">
              <p className="text-sm text-accent-foreground">Total Records</p>
              <p className="text-2xl font-bold text-accent-foreground">{summary.totalRecords}</p>
            </div>
            <div className="bg-primary/10 rounded-lg p-4">
              <p className="text-sm text-primary">Total Cost</p>
              <p className="text-2xl font-bold text-primary">Kshs {summary.totalCost.toFixed(0)}</p>
            </div>
            <div className="bg-primary/10 rounded-lg p-4">
              <p className="text-sm text-primary">Resolved</p>
              <p className="text-2xl font-bold text-primary">{summary.byStatus.Resolved}</p>
            </div>
            <div className="bg-gold/10 rounded-lg p-4">
              <p className="text-sm text-gold">Ongoing</p>
              <p className="text-2xl font-bold text-gold">{summary.byStatus.Ongoing}</p>
            </div>
            <div className="bg-accent rounded-lg p-4">
              <p className="text-sm text-accent-foreground">Monitoring</p>
              <p className="text-2xl font-bold text-accent-foreground">{summary.byStatus.Monitoring}</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              {Object.entries(summary.byType).map(([type, data]) => (
                <div key={type} className="bg-card border rounded-lg p-3">
                  ...
                  <p className="text-lg font-bold text-accent-foreground">{data.count} records</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {Object.values(summary.byCattle).map((cow, idx) => (
                <div key={idx} className="bg-card border rounded-lg p-3">
                  ...
                  <p className="text-lg font-bold text-destructive">{cow.count} records</p>
