...
const OUTCOME_COLORS = {
  ...
  Stillborn: 'bg-destructive/10 text-destructive',
  Assisted: 'bg-gold/10 text-gold',
  'C-Section': 'bg-accent text-accent-foreground',
};
        ...
        {TABS.map(({ key, label, icon: Icon }) => (
          <button
            ...
            className={cn(
              ...
              activeTab === key ? 'bg-card text-primary shadow-sm' : 'text-muted-foreground hover:text-foreground/90'
            )}
          >
