          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-primary/10 rounded-lg p-4">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm text-primary">Total Income</p>
              </div>
              <p className="text-2xl font-bold text-primary mt-1">Kshs {summary.income.toFixed(2)}</p>
            </div>
            <div className="bg-destructive/10 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-destructive mt-1">Kshs {summary.expenses.toFixed(2)}</p>
            </div>
            <div className={`rounded-lg p-4 ${summary.profit >= 0 ? 'bg-accent' : 'bg-gold/10'}`}>
              <p className={`text-sm ${summary.profit >= 0 ? 'text-accent-foreground' : 'text-gold'}`}>Net Profit/Loss</p>
              <p className={`text-2xl font-bold mt-1 ${summary.profit >= 0 ? 'text-accent-foreground' : 'text-gold'}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {Object.entries(summary.byCategory).map(([category, data]) => (
                <div key={category} className="bg-card border rounded-lg p-3">
                  ...
                  <p className={`text-lg font-bold mt-1 ${data.type === 'Income' ? 'text-primary' : 'text-destructive'}`}>
