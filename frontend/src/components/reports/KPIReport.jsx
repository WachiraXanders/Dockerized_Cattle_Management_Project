...
function Trend({ value, suffix = '', invert = false }) {
  ...
  return (
    <span className={`flex items-center gap-1 text-xs font-medium ${positive ? 'text-primary' : 'text-rose-500'}`}>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="pt-5">
            ...
            <p className="text-2xl font-bold text-primary">{avgMilkToFeed.toFixed(2)} L/kg</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-5">
            ...
            <p className="text-2xl font-bold text-gold">{topPerformers.length}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-5">
                ...
                <tr key={cow.id} className="border-b last:border-0 hover:bg-muted/60">
                  ...
                  <td className="py-2.5 pr-4 text-right">
                    <Badge className={`text-xs ${
                      cow.score >= 60 ? 'bg-primary/10 text-primary' :
                      cow.score >= 30 ? 'bg-gold/10 text-gold' :
                  ...
                  <td className="py-2.5 pr-4 text-right">
                    {cow.milkToFeed !== null
                      ? <span className={cow.milkToFeed >= avgMilkToFeed ? 'text-primary font-medium' : 'text-gold'}>{cow.milkToFeed}</span>
                  ...
                  <td className="py-2.5 text-right font-medium text-accent-foreground">{cow.totalMilkLifetime}</td>
                </tr>
              ))}
              {kpiData.length === 0 && (
