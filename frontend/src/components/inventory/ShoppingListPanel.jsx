...
const STATUS_STYLES = {
  ...
  Dismissed: 'bg-muted text-gray-500',
};
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="flex gap-4">
            <div className="text-center">
              <p className="text-2xl font-bold text-gold">{summary.pending}</p>
              <p className="text-xs text-muted-foreground">Pending</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-accent-foreground">{summary.ordered}</p>
        ...
        <div className="flex items-center gap-2">
          {lowStockFeedCount > 0 && (
            <div className="flex items-center gap-1.5 text-xs text-gold bg-gold/10 border border-gold/20 px-3 py-1.5 rounded-lg">
            ...
            <TableBody>
              {filteredList.map((item) => (
                <TableRow key={item.id} className={cn(
                  ...
                  <TableCell>
                    <p className="text-sm font-semibold text-destructive">{item.current_stock_kg} kg</p>
                  ...
                  <TableCell>
                    {item.estimated_cost
                      ? <p className="text-sm text-primary font-medium">Kshs {item.estimated_cost?.toLocaleString()}</p>
