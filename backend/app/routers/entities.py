...
def list_records(
    ...
    if sort:
        ...
        if field == "created_date":
            ...
            # Postgres has no json_extract() — json_extract_path_text() is the
            # equivalent for a plain JSON column (works for JSONB too).
            order_col = func.json_extract_path_text(models.Record.data, field)
        else:
