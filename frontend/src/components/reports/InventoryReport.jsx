        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-primary/10 rounded-lg p-4">
              <p className="text-sm text-primary">Total Items</p>
              <p className="text-2xl font-bold text-primary">{filteredData.length}</p>
            </div>
            <div className="bg-accent rounded-lg p-4">
              <p className="text-sm text-accent-foreground">Total Value</p>
              <p className="text-2xl font-bold text-accent-foreground">Kshs {summary.totalValue.toFixed(0)}</p>
            </div>
            <div className="bg-gold/10 rounded-lg p-4">
              <p className="text-sm text-gold">Low Stock</p>
              <p className="text-2xl font-bold text-gold">{summary.lowStock}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {Object.entries(summary.byCategory).map(([category, data]) => (
                <div key={category} className="bg-card border rounded-lg p-3">
                  ...
                  <p className="text-lg font-bold text-primary">{data.count} items</p>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredData.map((item) => {
                    ...
                    return (
                      <TableRow key={item.id} className={isOutOfStock ? 'bg-destructive/10' : isLowStock ? 'bg-gold/10' : ''}>
                        ...
                        <TableCell>
                          {isOutOfStock ? (
                            ...
                            <Badge className="bg-gold/10 text-gold gap-1">
